...
class TurnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turno" do
    assert_difference('Turno.count') do
      post turnos_url, params: { turno: { codigoturno: @turno.codigoturno, horas: @turno.horas } }
    end
  ...
  test "should update turno" do
    patch turno_url(@turno), params: { turno: { codigoturno: @turno.codigoturno, horas: @turno.horas } }
